            ...
            if hw_raw:
                ...
                if age <= 600:
                    ...
                    hardware_dict = {
                        ...
                        "co2_ppm": hw_data.get("mq135_co2", 16.32),
                        "methane_ppm": hw_data.get("methane_ppm", hw_data.get("mq135_co2", 16.32)),
                        "co_ppm": co_val,
                        "mq7_co": co_val,
                        "smoke_ppm": hw_data.get("mq2_smoke", 0.70),
                        "lpg_ppm": hw_data.get("lpg_ppm", hw_data.get("mq2_smoke", 0.70)),
                        ...
                        "buzzer_status": hw_data.get("buzzer_status", "0"),
